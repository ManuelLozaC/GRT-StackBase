...
- API Tokens y preferencias persistidas del Data Engine tambien ya forman parte del shell.
...
- Pendiente: completar multi-tenant transversal, integraciones reales de storage y notificaciones multicanal, sync de API mas profunda y generalizar el contrato `core + modules` para nuevos modulos sin wiring adicional.
