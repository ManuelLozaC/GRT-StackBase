    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <p class="text-slate-600 max-w-3xl">Esta base ya opera sobre autenticacion API, tenancy por empresa, modulos administrables y demos tecnicas del core.</p>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm h-full">
                ...
                <div class="space-y-3 text-slate-700">
                    ...
                    <div><strong>Empresa:</strong> {{ activeOrganization?.nombre || 'Sin contexto activo' }}</div>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm h-full">
                ...
                <div v-else class="text-slate-500">Este usuario todavia no tiene empresas asociadas.</div>
            </div>
        </div>
